...
<head>
    ...
    <meta charset="utf-8">
    <title>Career Center Registration</title>
    ...
    <header id="header">
        <div class="container-fluid">
            ...
            <div id="logo" class="pull-left">
                <h1><a href="#intro" class="scrollto">New Career Center Registration</a></h1>
            </div>

            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    <li><a href="index.php">Home</a></li>
                    <li class="menu-active"><a href="empreg.php">Career Center Registration</a></li>
            ...
            <div class="box">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-1"><label id="leid">Career Center ID<span>&#42;</span></label></div>
                        <div class="col-md-5"><input type="text" class="form-control" id="eid" placeholder="Enter career center ID" name="eid" style="width:270px;" onBlur="usernamecheck()" required>
                            <span id='user-availability-status'></span>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="right"></span>
                        </div>
                        <div class="col-md-1 text-right"><label id="lename" style="display: none">&nbsp;&nbsp; Career Center Name<span>&#42;</span></label></div>
                        <div class="col-md-5"><input type="text" class="form-control" id="ename" placeholder="Enter career center name" name="ename" pattern=[A-Za-z]{2,30} title="Only alphabet" style="width:270px; display: none" required></div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-1 text-right">
                            <label id="lcity" style="display: none">Career Center Location<span>&#42;</span></label>
                        </div>
                        <div class="col-md-5">
